...
static void vg_init_baseBlock ( void )
{
   ...
   /* 36  */ VGOFF_(sh_edx)    = alloc_BaB(1);
   /* 37  */ VGOFF_(sh_ebx)    = alloc_BaB(1);
   /* 38  */ VGOFF_(sh_esp)    = alloc_BaB(1);
   /* 39  */ VGOFF_(sh_ebp)    = alloc_BaB(1);
   /* 40  */ VGOFF_(sh_esi)    = alloc_BaB(1);
   /* 41  */ VGOFF_(sh_edi)    = alloc_BaB(1);
   /* 42  */ VGOFF_(sh_eflags) = alloc_BaB(1);
...
UInt VG_(real_fpu_state_saved_over_syscall)[108/4];
